...
do
{
    Console.Clear(); // Har safar menyuni tozalab ko'rsatish uchun
    ...
    switch (asosiyTanlov)
    {
        case "1":
            ...
            Console.Write("2-sonni kiriting (Daraja ko'rsatkichi/Ikkinchi son): ");
    ...
    {
        Console.WriteLine("\n-------------------------------------------");
        Console.WriteLine("Dasturni davom ettirishni xohlaysizmi? (ha/yo'q)");
        string javob = Console.ReadLine().ToLower();
        if (javob == "yo'q" || javob == "yoq" || javob == "no")
        {
            dasturIshlayapti = false;
